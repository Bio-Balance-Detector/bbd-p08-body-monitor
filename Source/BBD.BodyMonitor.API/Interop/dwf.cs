...
public class dwf
{
    ...
    /// <summary>
    /// Check the state of the acquisition. To read the data from the device, set fReadData to TRUE. For single acquisition mode, the data will be read only when the acquisition is finished.
    /// </summary>
    /// <param name="hdwf">Interface handle.</param>
    /// <param name="fReadData">TRUE if data should be read.</param>
    /// <param name="psts">Variable to receive the acquisition state.</param>
    /// <returns></returns>
